...
import connectToChild from "../../node_modules/penpal/lib/parent/connectToChild";
import {
    Action,
    Actions,
    BorderNode,
...
class App extends React.Component<any, { layoutFile: string | null; model: Model | null; json?: string; adding: boolean; fontSize: string; realtimeResize: boolean; iframeSrc: string }> {
    ...
    constructor(props: any) {
        super(props);
        this.state = { layoutFile: null, model: null, adding: false, fontSize: "medium", realtimeResize: false, iframeSrc: "" };
    ...
    componentDidUpdate(
        ...
        // 当iframeSrc更新时建立Penpal连接
        if (this.state.iframeSrc && this.state.iframeSrc !== prevState.iframeSrc) {
            console.log(this.iframeRef.current, "this.iframeRef.current");
            this.connection = connectToChild({
                iframe: this.iframeRef.current,
                methods: {
                    updateState(obj: any) {
                        console.log("----parent method:", obj);
                        return "obj";
                    },
                },
            });
            this.callChildMethod(["", "MSFT", "AMZN", "GOOG", "ORCL", "CSCO"]);
        }
    }

    callChildMethod = (arr: Array<string>) => {
        this.connection &&
            this.connection.promise.then((child: any) => {
                child.linkedSymbolNotification(arr);
            });
    };
    loadIframe = () => {
        this.setState({
            iframeSrc:
                "http://localhost:5174?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJzZXNzaW9uSWQiOiJzZXNzaW9uX18xMDAwNDRfXzM5MjFjOTc1LWExOWEtNGJjNS1hODc4LTY3NmY2MjQ0NjBiZSIsInNvdXJjZXR5cGUiOiJXVCIsImlzcyI6ImRldi11c2VycyIsImlhdCI6MTcxMDQ2OTk3MSwiZXhwIjoxNzEwNTQxOTcxfQ.RnmTwd2Tw1WjMFZm9vB5EifZJaJ_CB4J44mQDOnhOFF0I-7muldup3-Z_dZuCGbIFSn9V_ntxgCmw2ujWcEwqc9F_K9qy2YV9QqjvWuXZa79QLfYp5WZEixbIIiiAIZImrBJmwxTOsLOnzFzhWb2MQ_-y8gdCHgrDA2cbUKHUTayoIxw9yAvmsY25t1YxKuNTplT9FbvvKOAB1aE7EViGpnIbODmAVS9mw2fldUBzQllrLxOSFfpSPrHU2USP9hULFC5HT_deRD6R_Jg1r2X2ApAT_zyj0NIAABFRlayAmm6MlouROuRrcUfdNZjHFgM7JVoycwLB1aQ7PlIma8fvw",
        });
    };
    onModelChange = () => {
        if (this.htmlTimer) {
        ...
        if (component === "json") {
            ...
            return iframeSrc ? (
                <iframe
                    title={node.getId()}
                    ref={this.iframeRef}
                    src="http://localhost:5174?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJzZXNzaW9uSWQiOiJzZXNzaW9uX18xMDAwNDRfXzM5MjFjOTc1LWExOWEtNGJjNS1hODc4LTY3NmY2MjQ0NjBiZSIsInNvdXJjZXR5cGUiOiJXVCIsImlzcyI6ImRldi11c2VycyIsImlhdCI6MTcxMDQ2OTk3MSwiZXhwIjoxNzEwNTQxOTcxfQ.RnmTwd2Tw1WjMFZm9vB5EifZJaJ_CB4J44mQDOnhOFF0I-7muldup3-Z_dZuCGbIFSn9V_ntxgCmw2ujWcEwqc9F_K9qy2YV9QqjvWuXZa79QLfYp5WZEixbIIiiAIZImrBJmwxTOsLOnzFzhWb2MQ_-y8gdCHgrDA2cbUKHUTayoIxw9yAvmsY25t1YxKuNTplT9FbvvKOAB1aE7EViGpnIbODmAVS9mw2fldUBzQllrLxOSFfpSPrHU2USP9hULFC5HT_deRD6R_Jg1r2X2ApAT_zyj0NIAABFRlayAmm6MlouROuRrcUfdNZjHFgM7JVoycwLB1aQ7PlIma8fvw"
                ...
                <ContextExample.Provider value="from context">
                    <div className="app">
                        <div className="toolbar" dir="ltr">
                            ...
                            <button onClick={() => this.callChildMethod(["", "TSLA", "AMZN", "GOOG", "ORCL", "CSCO"])}>Change Symbol TSLA</button>
